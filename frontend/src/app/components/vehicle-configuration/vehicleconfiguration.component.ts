...
export class VehicleconfigurationComponent implements OnInit {
  ...
  constructor(){
    ...
    this.principalImg = this.vehicleList[1].model.img;
    this.totalPrice = this.vehicleList[1].price;
    this.vehicleConfigurationList = {
      engine: {
        name: '',
        price: 0,
    },
    ...
    extras:[],
    totalPrice: this.vehicleList[1].price,
  };
  }
    ngOnInit(): void{
